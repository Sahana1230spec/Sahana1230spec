...
- **Features:** 
  - Trained PPO, SAC, and TD3 agents for collision-free navigation
  - Custom Gym environment with LiDAR, depth camera, and IMU sensors
...
- **Features:**
  - Analyzed 104,258+ accident records
  - Random Forest classifier achieving 73.4% accuracy
...
- **Features:** 
  - Smart style-to-visual transformation
...
- **Features:**
  ...
  - IP and ZIP code information lookup
...
*Under Review (2025)*  
Integrating spatial mapping with deep RL for improved UAV decision-making in unknown environments.
